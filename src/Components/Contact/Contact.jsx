...
const Contact = () => {
  ...
  const onSubmit = async (event) => {
    ...
    formData.append("access_key", "666bbf34-c489-40ae-ac55-7b7bf64e633e");
  ...
  return (
    <div className='contact'>
       <div className="contact-col">
        ...
        <ul>
            <li> <img src={mail_icon} alt="" /> siddharthaudichya97@gmail.com</li>
            <li> <img src={phone_icon} alt="" /> +91 9575850030</li>
            <li> <img src={location_icon} alt="" /> Bhopal, MP, India</li>
        </ul>
       </div>
       <div className="contact-col">
